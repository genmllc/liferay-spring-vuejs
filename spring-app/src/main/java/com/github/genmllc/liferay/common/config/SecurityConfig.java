...
public class SecurityConfig extends SpringSecurityPortletConfigurer  {
	...
	/**
	 * Return a repo that doesn't restrict the cookie path to the application one. The app is running in a portal so the default path isn't going to work.
	 * @return
	 */
	...
	/**
	 * Return a nice JSON error message instead of a html page
	 * @return
	 */
