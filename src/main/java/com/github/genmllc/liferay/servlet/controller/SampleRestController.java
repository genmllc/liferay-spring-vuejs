...
/**
 * Rest Controller. The base paths must start with the same path declared in {@link src\main\webapp\WEB-INF\web.xml} or they won't be protected by Spring security.
